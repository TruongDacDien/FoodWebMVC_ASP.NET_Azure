...
public class OrderRecordComponent : ViewComponent
{
	...
	public async Task<IViewComponentResult> InvokeAsync()
	{
		...
		var result = await _context.OrderDetails.OrderByDescending(od => od.Order.DayOrder).Select(o =>
			new OrderRecordViewModel
			{
				OrderId = o.OrderId,
				...
				TotalMoney = (double)(o.Order.OrderDetails != null
					? o.Order.OrderDetails.Sum(od => od.Quantity * od.Product.ProductPrice)
					: 0),
