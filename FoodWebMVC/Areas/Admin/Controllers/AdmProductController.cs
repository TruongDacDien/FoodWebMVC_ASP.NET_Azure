...
public class AdmProductController : Controller
{
	...
	public async Task<IActionResult> Create(
		[Bind(
			"ProductId,ProductName,ProductPrice,ProductDescription,ProductAmount,ProductDiscount,ProductImage,ProductDateCreated,CategoryId")]
		Product product)
	{
	...
	{
		if (_context.Products == null) return Problem("Entity set 'FoodWebMVCDbContext.Products'  is null.");
		var product = await _context.Products.FindAsync(id);
