...
public class Order
{
	...
	[DisplayName("Đã trả tiền")] public bool PaidState { get; set; }

	[DisplayName("Trạng thái đơn hàng")] public bool DeliveryState { get; set; }

	[DisplayName("Tổng tiền")] public decimal TotalMoney { get; set; }
