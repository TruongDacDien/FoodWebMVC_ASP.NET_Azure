...
{
	[DisplayName("Họ tên")] public string FullName { get; set; }
	...
	[DisplayName("Địa chỉ")] public string Address { get; set; }
}
...
public class InforViewModel
{
	...
	[DisplayName("Số điện thoại")] public string? Phone { get; set; }

	[DisplayName("Email")] public string Email { get; set; }

	[DisplayName("Địa chỉ")] public string Address { get; set; }

	[DisplayName("Hình đại diện")] public string? Image { get; set; }
}
