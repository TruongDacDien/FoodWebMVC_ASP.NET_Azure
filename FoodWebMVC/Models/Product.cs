...
public class Product
{
	...
	[DisplayName("Giá")] public decimal ProductPrice { get; set; }

	[DisplayName("Nội dung")] public string? ProductDescription { get; set; }
	...
	[DisplayName("Hình ảnh")] public string? ProductImage { get; set; }
